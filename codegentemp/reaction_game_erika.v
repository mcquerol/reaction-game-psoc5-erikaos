// ======================================================================
// reaction_game_erika.v generated from TopDesign.cysch
// 11/27/2021 at 20:14
...
module top ;
    ...
    UART_v2_50_0 UART_LOG (
        ...
        .rx_clk(Net_1651),
        .rx_data(Net_1652),
        .rx_interrupt(Net_1653),
        .tx(Net_1645),
        .tx_clk(Net_1654),
        .tx_data(Net_1655),
        .tx_en(Net_1656),
        .tx_interrupt(Net_1657));
    ...
    SPI_Master_v2_50_6 TFT_SPI (
        ...
        .mosi(wTFT_SDA),
        .reset(1'b0),
        .rx_interrupt(Net_1802),
        .sclk(wTFT_SCL),
        .sdat(Net_1803),
        .ss(Net_1804),
        .tx_interrupt(Net_1805));
    ...
    assign Net_1800 = 1'h0;

    assign Net_1806 = 1'h0;
