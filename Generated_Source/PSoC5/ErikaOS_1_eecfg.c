 ...
 **************************************************************************/
    ...
    int EE_cortex_mx_stack_3[TASK_3_STACK_SIZE];	/* Task 3 (tsk_sevenSet) */
    #endif
    #if ((1 == 2) && (EE_MAX_TASK > 3))
    #define TASK_4_STACK_SIZE 200/4 // size = 200 bytes
    int EE_cortex_mx_stack_4[TASK_4_STACK_SIZE];	/* Task 4 (tsk_ledBlink) */
    #endif
    #if ((1 == 2) && (EE_MAX_TASK > 4))
    #define TASK_5_STACK_SIZE 0/4 // size = 0 bytes
    int EE_cortex_mx_stack_5[TASK_5_STACK_SIZE];	/* Task 5 (tsk_output) */
    #endif
    #if ((1 == 2) && (EE_MAX_TASK > 5))
    #define TASK_6_STACK_SIZE 0/4 // size = 0 bytes
    int EE_cortex_mx_stack_6[TASK_6_STACK_SIZE];	/* Task 6 (tsk_output) */
    #endif
    ...
    struct EE_TOS EE_cortex_mx_system_tos[EE_CORTEX_MX_SYSTEM_TOS_SIZE] = {
        ...
        #endif
        #ifdef TASK_3_STACK_SIZE
        ,{(EE_ADDR)(&EE_cortex_mx_stack_3[(TASK_3_STACK_SIZE) - CORTEX_MX_INIT_TOS_OFFSET])} 	/* tsk_sevenSet*/
        #endif
        #ifdef TASK_4_STACK_SIZE
        ,{(EE_ADDR)(&EE_cortex_mx_stack_4[(TASK_4_STACK_SIZE) - CORTEX_MX_INIT_TOS_OFFSET])}    /* tsk_ledBlink*/
        #endif
        #ifdef TASK_5_STACK_SIZE
        ,{(EE_ADDR)(&EE_cortex_mx_stack_5[(TASK_5_STACK_SIZE) - CORTEX_MX_INIT_TOS_OFFSET])}    /* tsk_output*/
        #endif
        #ifdef TASK_6_STACK_SIZE
        ,{(EE_ADDR)(&EE_cortex_mx_stack_6[(TASK_6_STACK_SIZE) - CORTEX_MX_INIT_TOS_OFFSET])}    /* tsk_output*/
        #endif
        #ifdef TASK_7_STACK_SIZE
 ...
 **************************************************************************/
    ...
    #endif
    #if EE_MAX_TASK > 2
    DeclareTask(tsk_sevenSet);
    #endif
    #if EE_MAX_TASK > 3
    DeclareTask(tsk_ledBlink);
    #endif
    #if EE_MAX_TASK > 4
    ...
    #endif
    #if EE_MAX_TASK > 2
        ,&EE_oo_thread_stub      /* thread tsk_sevenSet */
    #endif
    #if EE_MAX_TASK > 3
        ,&EE_oo_thread_stub      /* thread tsk_ledBlink */
    #endif
    #if EE_MAX_TASK > 4
